...
def main():
    ...
    try:
        ...
        world = client.load_world('Town02') # default = Town10
        print(client.get_available_maps())
        
        blueprintLibrary = world.get_blueprint_library()
        vehicle_bp = blueprintLibrary.filter('cybertruck')[0] # model3, prius, t2, etc (Reference: https://carla.readthedocs.io/en/latest/bp_library/) 
        transform = carla.Transform(carla.Location(x=130, y=195, z=40), carla.Rotation(yaw=180))
        vehicle = world.spawn_actor(vehicle_bp, transform) # Reference: https://carla.readthedocs.io/en/latest/core_actors/
        actorList.append(vehicle)
        
        """ References: https://carla.readthedocs.io/en/latest/core_sensors/
